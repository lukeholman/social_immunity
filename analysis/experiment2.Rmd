...
print(paste("Probability that |LOR|<2 for % bees leaving voluntarily:", ROPE_calculation(2, LOR_left)))
print(paste("Probability that |LOR|<2 for % bees forced out:", ROPE_calculation(2, LOR_forced)))
```
