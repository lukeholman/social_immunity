...
ROPE_calculation <- function(scale, LOR_data){
  sum(LOR_data > -log(scale) & LOR_data < log(scale)) / length(LOR_data)
}

ROPE_calculation(1.5, LOR_left)
ROPE_calculation(2, LOR_left)
ROPE_calculation(1.5, LOR_forced)
ROPE_calculation(2, LOR_forced)
...
hypothesis(difference_prop_forced_out_LOR, "x > 0", alpha = 0.05)$hypothesis
```
