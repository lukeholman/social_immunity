...
<!-- #### Inspect the prior and posterior estimates of the treatment effects -->
<!-- ```{r} -->
<!-- plot_hyp <- function(hypoth, xlim = c(-7,7)){ -->
<!--   (plot(hypothesis(exp1_model, hypoth), plot =F)[[1]]) +  -->
<!--     geom_vline(xintercept = 0, linetype = 2) + coord_cartesian(xlim = xlim) -->
<!-- } -->

<!-- grid.arrange( -->
<!--   plot_hyp("mu2_treatmentLPS = 0"), -->
<!--   plot_hyp("mu3_treatmentLPS = 0") -->
<!-- ) -->


<!-- grid.arrange( -->
<!--   plot_hyp("mu2_treatmentLPS - mu2_treatmentHeatMtreatedLPS   = 0"), -->
<!--   plot_hyp("mu3_treatmentLPS - mu3_treatmentHeatMtreatedLPS   = 0") -->
<!-- ) -->
<!-- ``` -->

<!-- ```{r} -->
<!-- hypothesis(exp1_model, c("mu2_treatmentLPS > 0", -->
<!--                          "mu3_treatmentLPS > 0", -->
<!--                          "mu2_treatmentLPS - mu2_treatmentRingers > 0",  -->
<!--                          "mu3_treatmentLPS - mu2_treatmentRingers > 0"), -->
<!--            alpha = 0.05)$hypothesis %>% -->
<!--   select(-Star) %>% -->
<!--   kable(digits = 3) %>% kable_styling(full_width = FALSE) -->
<!-- ``` -->
